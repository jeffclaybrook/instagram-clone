...
const ProfileAvatar = ({ user, children }: { user: UserWithExtras; children: ReactNode }) => {
 ...
 return (
  <Dialog open={open} onOpenChange={setOpen}>
   ...
   <DialogContent className="dialogContent">
    <DialogHeader>
     <DialogTitle className="mx-auto font-medium text-xl py-5">Change Profile Photo</DialogTitle>
    </DialogHeader>
    {isCurrentUser && (
     <Form {...form}>
      <form
